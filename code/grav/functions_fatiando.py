...
def gridder_regular(area, shape, z=None):
    ...
    Returned arrays will be flattened to 1D with ``np.ravel``.
    ...
    * ``[x, y]``
        np arrays with the x and y coordinates of the grid points
    * ``[x, y, z]``
        If *z* given. np arrays with the x, y, and z coordinates of the grid
        points
