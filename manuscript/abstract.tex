...
sensitivity matrix, reparametrization, wavelet compression,  iterative methods using the full sensitivity matrix,  iterative deconvolution  by using the concept of  block-Toeplitz Toeplitz-block (BTTB) matrices and
