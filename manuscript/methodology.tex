...
the block columns $\mathbf{G}_{c}[ \, : \, , \, : \, 2D_{b}]$ defined by equation \ref{eq:matrix-G-BCCB-1st-block-column-G}
...
As shown by \citet{takahashi-etal2020, takahashi-etal2022}, the number of CGLS iterations acts as a regularization for
the inverse problem. 
...
\begin{algorithm}
	...
	Compute $\boldsymbol{\mathcal{F}}_{2D_{B}} \, \boldsymbol{\mathcal{V}}_{c} \, \boldsymbol{\mathcal{F}}_{2D_{b}}$ via 2D-FFT\;
...
\begin{equation}
	\boldsymbol{\mathcal{V}}_{c} = 
	\boldsymbol{\mathcal{F}}_{2D_{B}}^{\ast} 
	\left[ \left( \boldsymbol{\mathcal{F}}_{2D_{B}} \, \boldsymbol{\mathcal{W}}_{c} \, \boldsymbol{\mathcal{F}}_{2D_{b}} \right)
	\circ \breve{\boldsymbol{\mathcal{L}}} \right] \boldsymbol{\mathcal{F}}_{2D_{b}}^{\ast} \: ,
