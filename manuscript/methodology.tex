...
\begin{equation}
	\mathbf{d}_{w} \approx \mathbf{G}_{w} \, \mathbf{p}_{w} \: ,
	\label{eq:linear-system-wavelet-domain}
\end{equation}

\begin{equation}
	\begin{split}
		\mathbf{d}_{w} &= \boldsymbol{\mathcal{W}} \, \mathbf{d} \\
		\mathbf{p}_{w} &= \boldsymbol{\mathcal{W}}^{\top} \mathbf{p} \\
...
\begin{equation}
	\left( \mathbf{G}_{s}^{\top}\mathbf{G}_{s} + \mu \, \mathbf{W}_{p} \right) 
\end{equation}
